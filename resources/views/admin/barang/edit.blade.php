    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="w-screen m-9">
                ...
                <div class="card-body" >
                    <form method="POST" action="{{ url('editbarang/'.$barang->id) }}" enctype="multipart/form-data">
                        @method('PATCH')
                      @csrf
                        <div class="mb-6">
                            <label for="nama_barang" class="">Nama Barang</label>
                            <input value="{{ $barang->nama_barang }}" type="text" id="nama_barang" name="nama_barang" class="form-control" placeholder="Masukan nama barang">
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <input value="{{ $barang->quantity }}" type="number" id="quanity" name="quantity" class="form-control" placeholder="Jumlah Barang">
                        </div>   
                        <div class="mb-6">
                            <label for="number" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Harga Barang</label>
                            <input value="{{ $barang->harga }}" type="text" id="harga" name="harga" class="form-control" placeholder="Harga Barang">
                        </div>
                        <div class="mb-6">
                            <label for="deskripsi" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Deskripsi</label>
                            <input value="{{ $barang->deskripsi }}" type="text" id="deskripsi" name="deskripsi" class="form-control" placeholder="Deskripsi barang">
                        </div>
                        <div class="mb-6">
                            <label for="penjual" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Penjual</label>
                            <input value="{{ $barang->penjual }}" type="text" id="penjual" name="penjual" class="form-control" placeholder="Nama Penjual">
                        </div>   
                        <div class="mb-6">
