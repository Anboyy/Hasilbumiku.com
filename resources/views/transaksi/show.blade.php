                      ...
                      <table class="table">
                        ...
                        @foreach($itemorder->cart->detail as $detail)
                          <tr>
                            ...
                            <td class="text-left">{{ number_format($detail->harga, 2) }}</td>
                            <td class="text-left">{{ number_format($detail->diskon, 2) }}</td>
                            <td class="text-left">{{ $detail->qty }}</td>
                            <td class="text-left">{{ number_format($detail->subtotal, 2) }}</td>
                          </tr>
                        @endforeach
                          <tr>
                            <td colspan="6">
